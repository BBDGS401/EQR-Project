...
```{r echo=FALSE}
rm(merged_data_cob, merged_data_midc, energy_hourly_data)
```
...
```{r echo=FALSE}
energy_no_breakdown_data <- data.table::fread("Final_Data_Files/final_energy_transactions_no_breakdown.csv")
```

```{r echo=FALSE}
energy_no_breakdown_data %>% filter(grepl('powerex', seller_company_name, ignore.case = TRUE))
```
